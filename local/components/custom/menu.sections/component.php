...
if($this->StartResultCache())
{
	...
	else
	{
		...
		while($arSection = $rsSections->GetNext())
		{
			...
			foreach($arParams['UF_FIELDS'] as $ufFeildCode) {
				if ($arSection[$ufFeildCode]) {
					$arResult["SECTIONS"][$arSection["ID"]]['UF_FIELDS'][$ufFeildCode] = $arSection[$ufFeildCode];
				}
			}
